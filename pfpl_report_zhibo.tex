...
The System \sT is a simple arithmetic evaluation system
 ...
 properties, I will list here a few systems that I find intersting the essential idea 
 in constructing those systems. However, in all these systems, the preservation and 
 progress theorems could all be proved, and such enables a clear and precise formulation 
...
capabilities ot define non-terminating functions. 
...
Given $x$ if type $A$, $inl(x)$ would be of type $A+B$. To destruct a sum type, 
...
a type application $\App\{\tau\}(e)$, inforamlly written as $e[\tau]$. 
...
In this reprot, I've presented the abstract syntax tree formulation. A case study with 
